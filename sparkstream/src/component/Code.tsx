...
// import test from "bittorrent-tracker";
const Code = () => {
  ...
  //   const languagesSelect = document.querySelector(
  //     "select#languages"
  ...
  //       "?room=" +
  //       encodeURIComponent(hexToBase64(newRoomId));
  //   }
  ...
  //     languagesSelect.innerHTML = monaco.languages
  //       .getLanguages()
